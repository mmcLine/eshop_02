...
public class EntityUtils {
	...
	public static <T> void setCreateInfo(T entity){
		...
		// 默认属性
		String[] fields = {"crtName","crtUser","crtHost","crtTime","deptId","orgId"};
		Field field = ReflectionUtils.getAccessibleField(entity, "crtTime");
		// 默认值
		Object [] value = null;
		if(field!=null&&field.getType().equals(Date.class)){
			value = new Object []{name,id,hostIp,new Date(),BaseContextHandler.getDept(),BaseContextHandler.getOrg()};
		}
		// 填充默认属性值
